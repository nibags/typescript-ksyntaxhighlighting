...
<!--
    ...
    NOTE:
     This file is generated by a script for JavaScript and TypeScript.
     See:  * data/generators/generate-react-syntax.py
           * data/generators/react.xml.tpl

    This file is an extension of the {{{NAME}}} highlighter
    ({{{NAME_LOWERCASE}}}.xml).
...
<language name="{{{NAME}}} React" version="3" kateversion="{{{KATEVERSION}}}" section="Scripts" indenter="cstyle"
          priority="6" extensions="{{{EXTENSIONS}}}" mimetype="{{{MIMETYPES}}}"
...
<highlighting>
	...
	<contexts>
		...
		<context name="Normal" attribute="Normal Text" lineEndContext="#stay">
			...
			<IncludeRules context="Normal##{{{NAME}}}" />
		</context>

		<!-- {{{NAME}}} -->

		<!-- Overwrite rules of '{{{NAME_LOWERCASE}}}.xml'. These rules send to contexts
		     that contain: <IncludeRules context="Normal"/> in the {{{NAME}}} XML file. -->
		<context name="Overwrite{{{NAME}}}" attribute="Normal Text" lineEndContext="#stay">
		...
		<context name="Object" attribute="Normal Text" lineEndContext="#stay">
			...
			<IncludeRules context="Object##{{{NAME}}}" />
		</context>
		...
		<context name="React" attribute="Normal Text" lineEndContext="#stay">
			...
			<!-- Overwrite {{{NAME}}} rules to highlight tags within some contexts -->
...
<!-- kate: syntax XML; replace-tabs off; tab-width 3; indent-width 3; remove-trailing-spaces mod; dynamic-word-wrap off; -->
